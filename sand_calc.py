...
def excel_maker(folder_name, num_runs):
    df_dict_output = dict()
    df_dict_target = dict()
    for run in range(num_runs):
...
if __name__ == '__main__':
    ...
    rel_error_table_nonormal(folder_name='./csv_files/paper/2d_110classes_allz', num_runs=4, num_epochs=30)
    excel_maker(folder_name='./saved/diff_run_res/2d_110classes_allz', num_runs=4)